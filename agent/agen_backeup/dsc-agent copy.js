...
app.post('/sign/pdf-resign-flatten', requireAuth, async (req, res) => {
  ...
  console.log('[pdf-resign-flatten] requestedPageIndex:', requestedPageIndex);
    ...
    try {
      ...
      console.log('[pdf-resign-flatten] pageCountTMP:', pageCountTMP);
      console.log('[pdf-resign-flatten] targetIndexTMP:', targetIndexTMP);
      ...
      try {
        console.log('[pdf-resign-flatten] req.body:', req.body);
        console.log('[pdf-resign-flatten] req.body.rect:', req.body.rect);
        const rn = (req.body && Array.isArray(req.body.rect) && req.body.rect.length === 2)
          ? req.body.rect.map((v) => Number(v))
          : null;
      ...
      const hasRectNorm = !!(req.body && Array.isArray(req.body.rect) && req.body.rect.length === 2);
